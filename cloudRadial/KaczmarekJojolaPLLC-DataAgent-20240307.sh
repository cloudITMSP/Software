...
if [ -z "https://cloudit.services-us.cloudradial.com" ]; then
    echo "Please enter a valid service endpoint URL."
    exit 1
fi
if [ -z "https://cloudit.us.cloudradial.com" ]; then
...
echo ""
echo "Service Endpoint: https://cloudit.services-us.cloudradial.com"
echo "Partner Url:      https://cloudit.us.cloudradial.com"
echo "Company Id:       90"
echo "Security Key:     "
echo ""
...
plutil -insert ProgramArguments -xml "<array><string>/Library/LaunchDaemons/CloudRadial.Mac.Agent/CloudRadial.Mac.Agent</string><string>https://cloudit.services-us.cloudradial.com</string><string>https://cloudit.us.cloudradial.com</string><string>90</string><string></string></array>" /Library/LaunchDaemons/com.cloudradial.mac.agent.plist
